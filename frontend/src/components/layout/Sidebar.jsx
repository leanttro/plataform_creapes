...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    ...(isAdmin ? [{ path: '/admin', icon: 'ph-shield-check', title: 'Admin' }] : []),
    ...
    <aside style={styles.sidebar}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
        <button
          ...
          title="Sair"
          style={{ ...styles.navItem, color: '#A0A0A5', background: 'transparent', border: 'none', cursor: 'pointer' }}
        >
...
const styles = {
  ...
  nav: { display: 'flex', flexDirection: 'column', gap: 24 },
  navItem: {
  ...
  avatar: {
    ...
    border: '2px solid #2D2D30', cursor: 'pointer'
  }
}
